...
const sql2716 = fs.readFileSync(MIGRATION_2716_PATH, "utf8");
const sql2714 = fs.readFileSync(MIGRATION_2714_PATH, "utf8");
const sql2715 = fs.readFileSync(MIGRATION_2715_PATH, "utf8");
